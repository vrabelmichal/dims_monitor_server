...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('rest_server', '0002_alter_report_hash'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpu_time_dpc_min', models.FloatField(help_text='Time spent servicing deferred procedure calls (DPCs) (Windows); DPCs are interrupts that run at a lower priority than standard interrupts.')),
